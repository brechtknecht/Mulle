          ...
          <div>
            ...
            <h3 class="light">
                 <countTo 
                    v-if="index != 3" 
                    :startVal='0' 
                    :endVal='Math.abs(parseInt(currentAnswers[index].answer.value))' 
                    :separator="''" 
                    :duration='3000'>
                </countTo>
          ...
          <div>
            ...
            <h3 class="light">
              <countTo 
                v-if="index != 3" 
                :startVal='0' 
                :endVal='Math.abs(parseInt(averageValues[index]))' 
                :separator="''" 
                :duration='3000'>
              </countTo>
              <span v-else>–</span>
          ...
          <div>
            ...
            <h3 class="light">
              <countTo 
                v-if="index != 3" 
                :startVal='0' 
                :endVal='parseInt(question.answer.number)' 
                :separator="''" 
                :duration='3000'>
              </countTo>
        ...
        .then(function(response) {
          ...
          for (var i = 0; i < NUMBER_OF_QUESTIONS; i++) {
            ...
            if (answer_array.length) {
              sum = answer_array.reduce(function(a, b) {
                return a + b;
              });
